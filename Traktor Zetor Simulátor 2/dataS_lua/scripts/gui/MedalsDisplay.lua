...
function MedalsDisplay:new()
  ...
  instance:addItem(Overlay:new("backgroundOverlay", "dataS2/missions/medals_background.png", 0.05, instance.posY, 0.9, instance.height))
  instance:addItem(Overlay:new("bronzeMedalOverlay", "dataS2/missions/bronze_medal.png", instance.posX + instance.medalsSpacingX * 2, instance.medalsPosY, instance.medalsHeight * 0.75, instance.medalsHeight))
  instance:addItem(Overlay:new("silverMedalOverlay", "dataS2/missions/silver_medal.png", instance.posX + instance.medalsSpacingX * 1, instance.medalsPosY, instance.medalsHeight * 0.75, instance.medalsHeight))
  instance:addItem(Overlay:new("goldMedalOverlay", "dataS2/missions/gold_medal.png", instance.posX + instance.medalsSpacingX * 0, instance.medalsPosY, instance.medalsHeight * 0.75, instance.medalsHeight))
  return instance
end
