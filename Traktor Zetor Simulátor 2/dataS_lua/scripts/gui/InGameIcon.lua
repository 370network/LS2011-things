...
function InGameIcon:new()
  ...
  instance.time = 0
  instance.alpha = 0
  instance.fileName = "dataS2/missions/bottle.png"
  instance.text = "+1"
...
function InGameIcon:draw()
  if self.visible then
    ...
    renderText(self.textPosX, self.textPosY - 0.003, 0.035, self.text)
    setTextColor(0.5, 1, 0.5, self.alpha)
    renderText(self.textPosX, self.textPosY, 0.035, self.text)
