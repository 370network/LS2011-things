StationFillMission = {}
local StationFillMission_mt = Class(StationFillMission, FSBaseMission)
function StationFillMission:new(baseDirectory, customMt)
  local mt = customMt
  if mt == nil then
    mt = StationFillMission_mt
  end
  local self = StationFillMission:superClass():new(baseDirectory, mt)
  self.savedGrain = 0
  self.renderTime2 = true
  return self
end
